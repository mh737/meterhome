    ...
    return (
        <>
            <div id="navbar">
                <div className="nav">
                    <NavLink href="/">
                        <div className="navleft justify-self-start">
                ...
                <a href="/support">Supported device</a> */}
                    ...
                    <div className="navright hidden md:visible justify-self-end">
                    ...
                    <div className="navright visible md:hidden justify-self-end">
