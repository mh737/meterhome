        ...
        <div className="nav !flex justify-between items-center md:!pt-[10px] !pt-0 mx-[5%] my-0">
          ...
          <div className="navcenter justify-center items-center flex-nowrap !hidden md:!flex flex-1 text-center leading-[1.1]">
            ...
            <div className="dropdown-home-nav">
              <NavLink
                href="/"
                className={
                  pathname == "/" ? "link underline decoration-2 " : "link"
                }
              >
                {t("homepage")}
              </NavLink>
          ...
          <div className="flex md:hidden basis-auto">
            <button onClick={toggleNavbar}>
              {!isClick ? (
                <Image src={ham} width={47} height={47} alt="menu"></Image>
              ) : (
                <Image src={cross} width={47} height={47} alt="menu"></Image>
              )}
            </button>
            <NavLink
              href="/contact-us"
          ...
          {isClick && (
            <>
              <div className="block">
                <NavLink
                  href="/"
                  className="block hover:bg-white hover:text-black text-white p-3"
                >
                  {pathname == "/" ? "|  " : "   "}
                  {t("homepage")}
                </NavLink>
              ...
              <div className="flex justify-end">
                <NavLink
                  href={pathname}
                  locale={t("change-lang-locale")}
                  className="hover:bg-white hover:text-black text-white en p-3 m-2"
                >
                  {t("change-lang-text")}
                </NavLink>
